...
export const prizeCategories: PrizeCategory[] = [
  {
    ...
    benefits: [
      "AIFFA Best Feature Film Trophy",
      "Winner Certificate + Official Winner Laurel",
      "Winner Spotlight across AIFFA website and social channels (featured placement + dedicated winner page)",
      "Official Press Release announcement",
      {
        label: "Entry to the IFFA Awards Ceremony 2026 (complimentary)",
        href: "https://www.iffa.com.au/",
      },
  ...
  },
  {
    ...
    benefits: [
      ...
      "Priority consideration for future AIFFA showcases, industry sessions, and development initiatives",
    ],
  },
  {
    title: "Best Director",
  ...
  },
  {
    ...
    benefits: [
      "AIFFA Best Cinematography Trophy",
      "Winner Certificate + Official Winner Laurel",
      "Winner Spotlight across AIFFA website and social channels (featured placement + dedicated winner page)",
      "Official Press Release announcement",
      {
  ...
  },
  {
    ...
    benefits: [
      "AIFFA Audience Choice Award Trophy",
      "Winner Certificate + Official Winner Laurel",
      ...
      "Highlighted audience engagement feature across AIFFA digital platforms",
      "Priority consideration for future AIFFA showcases and audience-driven initiatives",
    ],
  },
];

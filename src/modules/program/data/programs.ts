export const programDays = {
  ...
  "day-2": {
    ...
    dayActivities: [
      ...
      "Collaborative development discussions",
    ],
    eveningActivities: [
      "Curated film screening",
      "Q&A with filmmakers and mentors",
    ],
  },
  ...
  "day-3": {
    ...
    dayActivities: [
      ...
      "Career sustainability and funding insights",
    ],
    eveningActivities: [
      "Industry-focused curated screening",
    ],
  },
  ...
  "day-4": {
    ...
    dayActivities: [
      ...
      "Pre-production team preparation",
    ],
    eveningActivities: [
      "Curated screening with creative discussion",
    ],
  },
  ...
  "day-5": {
    ...
    dayActivities: [
      ...
      "Active production across teams",
    ],
    eveningActivities: [
      "Team check-ins and informal networking",
    ],
  },
  ...
  "day-6": {
    ...
    dayActivities: [
      ...
      "Rough cut reviews and feedback",
    ],
    eveningActivities: [
